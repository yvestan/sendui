...
define('JELIXS_INFO_DEFAULT_IDSUFFIX','@grafactory.net');

// Your website, or the domain name of your application
define('JELIXS_INFO_DEFAULT_WEBSITE','http://www.grafactory.net/sendui');

// label of the license of your files. ex: GPL, Gnu Public License
define('JELIXS_INFO_DEFAULT_LICENSE','GPL Gnu Public Licence');

// the URL where we can read the license you choose
define('JELIXS_INFO_DEFAULT_LICENSE_URL','http://www.grafactory.net/sendui/licence');

// the default creator name (your name for example..)
define('JELIXS_INFO_DEFAULT_CREATOR_NAME','Yves Tannier [grafactory.net]');

// the email of the creator
define('JELIXS_INFO_DEFAULT_CREATOR_EMAIL','yvestanSANSPAM@gmail.com');

// Copyright informations
define('JELIXS_INFO_DEFAULT_COPYRIGHT','2009 Yves Tannier');
